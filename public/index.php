...
<div class="side-nav">
    <div class="nav-dot active" data-id="section-hero" title="Inicio" onclick="document.getElementById('section-hero').scrollIntoView({behavior: 'smooth'})"></div>
...
<div class="scroll-container" id="main-scroller">
            ...
            <div class="flex-row justify-between about-container">
                ...
                <div style="width: 100%">
                    <div class="content-panel active" id="content-1">
                        ...
                        <p>
                            Dile adiós a las hojas de cálculo complicadas. <span style="color: var(--accent-color); font-weight: 600">StockiFy</span>
    ...
    <section class="section bg-pattern" id="section-pillars">
        <h2 style="margin-bottom: 3rem; z-index: 2;">Tus herramientas principales</h2>
    ...
    <section class="section carousel-section bg-pattern" id="section-gallery" style="justify-content: space-between;">
        ...
        <div class="swiper mySwiper" style="z-index: 2; width: 100%;">
        ...
        <footer class="footer footer-snap" style="width: 100%; z-index: 2;">
            <div class="footer-container">
                ...
                <div class="footer-bottom">
                    ...
                    <p class="footer-dev">Created by <span style="color: var(--color-white); font-weight: bold">JESMdev</span></p>
                </div>
            </div>
        </footer>
    </section>
