    ...
    renderBaseStructure() {
        return `
            <div class="purchases-layout">
                ...
                <div id="create-purchase-modal" class="modal-overlay hidden" style="display:none; z-index:1000;">
                    <div class="modal-content" style="width: 95%; max-width: 2000px; height: 85vh;">
                        ...
                        <div class="purchase-modal-body" id="purchase-modal-body">
                            ...
                            <div id="mobile-purch-bar" class="hidden-desktop" style="display:none; position:fixed; bottom:0; left:0; width:100%; background:white; padding:15px; padding-bottom:calc(15px + env(safe-area-inset-bottom, 0px)); border-top:1px solid #ccc; box-shadow:0 -5px 15px rgba(0,0,0,0.1); z-index:99999;">
                ...
                <div id="detail-purchase-modal" class="modal-overlay hidden" style="align-items:center; justify-content:center; display:none; z-index:20000; padding: 20px;" onclick="if(event.target === this) window.purchasesModule.closeModal('detail-purchase-modal')"><div class="modal-content" style="width: 500px; max-width: 100%; background: #fff; border-radius: 16px; margin: auto; box-shadow: 0 10px 30px rgba(0,0,0,0.2);"><div class="modal-header" style="padding: 15px; border-bottom: 1px solid #eee; display: flex; justify-content: space-between; align-items: center;"><h3 style="margin: 0; font-size: 1.2rem;">Detalle de Movimiento</h3><button class="modal-close-btn" id="close-detail-purch-modal" onclick="window.purchasesModule.closeModal('detail-purchase-modal')">&times;</button></div><div class="modal-body" id="detail-purch-content" style="padding: 20px; overflow-y: auto; max-height: calc(100vh - 120px);"><div class="purchase-modal-body"></div></div></div></div>
            </div>
        `;
    }
