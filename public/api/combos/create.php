...
try {
    ...
    $comboId = $comboModel->createCombo((int)$activeInventoryId, $name, $price, $items);
    ...
    if ($comboId) {
        ...
        try {
            ...
            \App\helpers\ActivityLogger::log(
                ...
                'combo',
                (string)$comboId,
                "Creó el combo '$name' por $" . number_format($price, 2, ',', '.'),
        ...
        echo json_encode(['success' => true, 'combo_id' => $comboId, 'message' => 'Combo creado con éxito.']);
    } else {
        echo json_encode(['success' => false, 'message' => 'No se pudo crear el combo en la base de datos.']);
    }
