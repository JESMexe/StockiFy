...
try {
    ...
    $name = $existing['name'];
    $success = $comboModel->deleteCombo($comboId);
    ...
    if ($success) {
        ...
        echo json_encode(['success' => true, 'message' => 'Combo eliminado con éxito.']);
    } else {
        echo json_encode(['success' => false, 'message' => 'No se pudo eliminar el combo de la base de datos.']);
    }
